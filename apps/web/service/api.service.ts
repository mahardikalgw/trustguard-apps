...
export class ApiService {
  ...
  getById = async(baseUrl: string, endpoint: string, header: object, id: number) => await axios.get(`${baseUrl}/${endpoint}/${id}`, header)
  post = async(baseUrl: string, endpoint: string, header: object, data: object) => await axios.post(`${baseUrl}/${endpoint}`, data, header)
  put = async(baseUrl: string, endpoint: string, header: object, data: object, id: number) => await axios.put(`${baseUrl}/${endpoint}/${id}`, data, header)
